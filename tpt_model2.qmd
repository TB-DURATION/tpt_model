...
```{r}
ts <- seq2(0, 30)
plot3(ts, hill(ts, 10, 1, 1), ylim = 0:1, ylab = "treatment efficacy")
```
...
```{r}
(sid_p_val <- sid_param_val(2e4, 176, 322))
```
...
siid_equ_val <- siid_equ(N = N, pi = 0, p = siid_p_val[["p"]],
