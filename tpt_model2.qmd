...
```{r}
sid_equ2 <- function(N = 1e5, p, beta, gammas, gammaf, deltas, deltaf, alpha) {
...
```{r}
sid_equ2(N = 1e5, p = 1, beta = .00001, gammas = 1 / 70, gammaf = 0, deltas = 1 / 50, deltaf = 1 / 5, alpha = 1 / 70)
```
...
plot_dyn_equ2 <- function(
  ...
  equs <- sid_equ2(N, p, beta, gammas, gammaf, deltas, deltaf, alpha)
